...
As shown in \ref{eq:ipat}, human population has a major effect in determining our impact on the planet. 
...
\textit{Homo sapiens} emerged as a species 100,000 to 200,00 years ago, although estimates vary considerably.
Population grew slowly. By 9000 BC there were 5 to 10 million humans. Around the 
year 1 AD there were around 300 million people, an average growth rate of about 0.1\%.
By 1650 AD the world population was around 500 million. Average growth was slowed 
by the trade and urbanization enabling infectious diseases to kill large numbers.
For instance, the Black Death killed 75 to 200 million people in the 1300s.
World population reached 1 billion (1000 million) around 1800 AD. 
...
a peak growth rate of 2.1\% between 1965 and 1970. 
...
\begin{figure}
\centering
\includegraphics[width=1\linewidth]{figures/DTTstages.gif}
