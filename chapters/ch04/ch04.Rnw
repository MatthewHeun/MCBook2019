...
% Energy is a significant sustainabilty challenge 
...
% Energy \emph{sinks} include the atmosphere, Earth's crust, and bodies of water which absorb 
% products of combusion including
% gases (\CO2) and lightweight solids (CO$_2$, H$_2$O, and particulate matter)
% and 
% heavy solids (ash and heavy metals)
% wastes
% from energy consumption, respectively. 
% emissions of particulate matter and emissions, the products of combusion.
...
% Emissions from energy consumption include greenhouse gases (GHGs), primarily CO$_2$.
% In the Earth's atmosphere, 
% accumulation of all types of greenhouse gases 
% (CH$_4$, N$_2$O, HFCs, and PFCsin addition to CO$_2$) 
% warms the Earth and
% disrupting natural climate systems that were in balance for millennia
% before the dawn of the industrial revolution.
% 
% 
% ****Reframe in terms of sources and sinks.*****
% 
% There are many causes of GHG accumulation in the atmosphere.
% Fossil fuel consumption emits CO$_2$.
...
% Agricultural activity (especially livestock) emit CH$_4$ in copious amounts.
...
Economic activity (see chapter~\ref{chap:energy}) drives energy consumption, and 
when primary energy is supplied by carbon-intensive fossil fuels, GHG emissions are the result.
...
\begin{figure}
\centering
\includegraphics[width=1\linewidth]{chapters/ch04/IEASankeyDiagram2016.pdf}
\caption[World Sankey]{World energy flows Sankey diagram~\citep{International-Energy-Agency:aa}.}
\label{fig:IEA_sankey}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.6\linewidth]{chapters/ch04/Fouquet2011_energy_transitions.png}
