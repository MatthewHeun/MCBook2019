...
Non-renewable sources entail resource depletion concerns.
Energy and products of combustion \emph{sinks} include 
the atmosphere, plants and trees, the Earth's crust, and bodies of water.
...
Agricultural\index{agriculture}
activity (especially livestock farming\index{livestock}) 
emits CH$_4$
in copious amounts.
Decomposing landfill waste\index{waste!landfill}
(especially organic matter) releases methane and nitrous oxide.
...
Land use changes (especially deforestation\index{deforestation}) 
reduce CO$_2$ sequestration\index{sequestration!carbon dioxide} 
by plants and trees,
reducing the planet's capacity to remove CO$_2$.
Furthermore, energy, especially diesel to operate heavy equipment, is required to cut down forests, 
showing that deforestation both reduces GHG sequestration and contributes to GHG emissions.
Thus, the continuous rise of fossil fuel consumption and the steady pace of deforestation
have both amplified the sources and reduced the sinks of GHGs,
leading to annual increases in CO$_2$ concentration in Earth's atmosphere.
...
is supplied at the present time by renewable sources
...
time, money, and efficiency backfire. 

Throughout history, societies have used different primary energy\index{energy!primary}
sources in varying proportions. 
Longitudinal analysis of those proportions indicates the speed of past energy transitions\index{energy transition!speed of} and
...
from 1500--2000.
The figure shows that the transition from food, feed, and biomass to coal\index{energy transition!biomass to coal}
took many centuries.
...
can effect the fossil-to-renewables transition in the decade or two that we have available?
...
For context, the \$5 trillion annual cost is 7.2~\% of GDP\index{gross domestic product (GDP)}
(\$69 trillion/year).
The money challenge is this: 
what source will provide the necessary funds for a fossil-to-renewables transition
...
can energy efficiency be deployed to reduce GHG emissions 
\emph{without} inadvertantly stimulating the economy,
thereby increasing energy consumption and energy-related GHG emissions?
