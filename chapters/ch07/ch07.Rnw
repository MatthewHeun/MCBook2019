...
<<GHG_from_food, echo = FALSE, fig.cap = "Percentages of greenhouse gas emissions from food consumption.", fig.height = 4>>=
...
ggplot2::ggplot(data = Food_GHG, mapping = aes(x = "", y = percentages, fill = food_categories)) + 
