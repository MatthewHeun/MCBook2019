...
Figure~\ref{fig:pounds_serving} shows how much carbopn dioxide is released from one pound of food~\citep[Fig.~2]{Heller_2014}.

\begin{figure}
\centering
\includegraphics[width=0.75\linewidth]{chapters/ch07/Pounds_of_CO2_per_serving.pdf}
\caption[Pounds of CO2 per serving.]{Pounds of carbon diaoxide CO2 per serving~\citep[Fig.~2]{Heller_2014}.}
