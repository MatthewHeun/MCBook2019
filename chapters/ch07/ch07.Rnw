...
emissions that originate in the food delivery system.
...
Figure~\ref{fig:pounds_serving} reinforces the facts from above,
namely that animal-based foods have much more environmental impact than 
plant-based foods.
...
\begin{figure}
\centering
\includegraphics[width=1\linewidth]{chapters/ch07/FoodDesertsUS.jpg}
...
\itme Use a food emissions calculator such as the one suggested in this chapter~\cite{CleanMetrics:aa}
