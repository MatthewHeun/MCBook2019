...
% How close do you live to work, church, and stores? & Close (to walk and cycle)              \\
% What do you eat?                                   & Closer to the bottom of the food chain \\ 
% \bottomrule
% \end{tabular}
% \end{table}
...
How big is your house?                                                                        & Small and used                         \\
What car do you drive?                                                                        & Small and used                         \\
\begin{tabular}[c]{@{}l@{}}How close do you live to \\ work, church, and stores?\end{tabular} & Close (to walk and cycle)              \\
