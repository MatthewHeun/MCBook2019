...
This chapter focuses on a few important aspects of household living:
%
\begin{enumerate*}[label={(\alph*)}]
	
  \item purchasing or renting a home or apartment 
...
\item This chapter covered four important aspects of household sustainability
      ...
      from a sustinability point of view? (recycling, waste)
      
\item What tradeoffs do you observe in daily household living?
      I.e., in what areas of household living does sustainability become worse
