...
Households are site of energy and material consumption.

Often, people have little control over sustainability practices at work, school, or church,
because other people (physical plant, custodial staff, supervisors) 
make decisions about energy, material, and other resource consumption.

But, households are one place where many people can exercise control over 
decision that affect sustainability. 
Households are the site where sustainability meets everyday life.


Purchasing a home or renting an apartment 
(how close to work, school, grocery store, church, entertainment;
how large)

laundry (energy, water, clothing choices, line drying.)

energy (heating, cooling, lights, refrigeration)

water (toilets, sinks, dishwashing, showers)

food (purchases, waste, See Chapter~\ref{chap:food_and_agriculture}.)
...
waste (everyday, food scraps, subscriptions, hazardous, )
...
\begin{enumerate*}[label={(\alph*)}]
  ...
  \item heating and cooling (furnace, A/C, insulation)
  
  \item hygeine (showers, dishes, toilet, laundry)
  
  \item lighting (incandescent vs.\ LED)
    
\end{enumerate*}
%

Choices made in each arena have energy and material implications.
