...
<<Tonne_km, fig.scap = "U.S \\ tonne_km", fig.cap = "U.S.\ freight by transportation mode. **** Larisa: add reference ****", fig.width = 5, fig.height = 3, echo = FALSE>>=
...
<<Paasenger_km, fig.scap = "U.S passenger_km", fig.width = 5, fig.height = 3, echo = FALSE>>=
...
2010	742	309	(R) 386	15	153	44	43	47\n
2011	737	295	(R) 384	16	149	46	46	47\n
2012	736	292	(R) 384	17	145	39	43	49\n
2013	736	(R) 293	(R) 390	18	149	39	44	55\n
