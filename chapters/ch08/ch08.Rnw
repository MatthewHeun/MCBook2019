...
\begin{figure}
\centering
\includegraphics[width=1\linewidth]{chapters/ch08/biofuel_consumption.pdf}
\caption[Biofuel consumption 1985-2017]{Biofuel consumption in the US 1985-2017.}
\label{fig:biofuel_consumption}
\end{figure}
