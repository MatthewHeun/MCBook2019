...
U.S.\ transportation service provision by mode
are shown in Figures~\ref{fig:passengerkm_by_mode} 
and~\ref{fig:freight_by_mode}.

\begin{figure}
\centering
**** Add a figure here. ****
% \includegraphics[width=1\linewidth]{chapters/ch08/Total_US_tonne-kilometers_of_freight.pdf}
\caption[Personal transport by mode.]{Passenger-km of personal transport by mode.}
\label{fig:personal_transport_by_mode}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=1\linewidth]{chapters/ch08/Total_US_tonne-kilometers_of_freight.pdf}
\caption[Freight by mode.]{Tonne-kilometers of freight by transport mode.}
\label{fig:freight_by_mode}
\end{figure}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Transportation sustainability concerns}
\label{sec:transportation_concerns}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
by liquid petroleum fuels,
because of their high energy densities\index{energy density!liquid fuels}
in terms of both energy-to-mass and energy-to-volume ratios.
Burning liquid fuels to provide transportation services has global warming\index{global warming}
implications, and 
greenhouse gas~(GHG) emissions from transportation are a significant sustainability concern.
...
\begin{figure}
\centering
\includegraphics[width=1\linewidth]{chapters/ch08/CO2_and_GHG_Emissions_by_Mode.pdf}
\caption[Emissions by transport mode.]{CO$_2$ emissions by transportation mode.}
\label{fig:transport_GHG_emissions}
\end{figure}

Other emissions from transportation in the form of particulate matter\index{particulate matter}
raise significant health concerns as well.
Furthermore, consumption of nonrenewable fossil fuels has implications for energy resource depletion.
...
Factors that drive demand for transportation services include 
...
\begin{figure}
\centering
\includegraphics[width=1\linewidth]{chapters/ch08/US_Transportation_to_Work.pdf}
\caption[Commuting by mode.]{Share of commuting distance by mode.}
\label{fig:commuting_by_mode}
\end{figure}

Interestingly, 
Figures~\ref{fig:personal_transport_by_mode} and~\ref{fig:freight_by_mode}
...
Thus, it is clear that the need for transport is driven, in large part, 
...
\begin{enumerate*}[label={(\alph*)}]
  ...
  \item improve transportation machine efficiency and        
...
%++++++++++++++++++++++++++++++
\subsection{Transportation efficiency}
\label{sec:transportation_efficiency}
%++++++++++++++++++++++++++++++

Vehicle efficiency is usually quantified in distance travelled per volume 
of fuel consumed.\index{efficiency!fuel}
Figure~\ref{fig:US_mpg} shows U.S.\ fleet average fuel economy
as a function of time for cars, trucks, and overall.
Truck efficiency has lagged car efficiency by 20--30\% for decades.
In the 1970s, overall efficiency was nearly the same as car efficiency,
because most vehicles on the road were cars.
However, the increasing popularity of trucks and sport utility vehicles in the U.S.\
...
\begin{figure}
\centering
\includegraphics[width=1\linewidth]{chapters/ch08/MPGByModelYear_1975-2017.pdf}
\caption[U.S.\ fuel economy.]{U.S.\ Fuel economy by year and vehicle type.}
\label{fig:US_mpg}
\end{figure}
...
In addition to vehicle design, driving habits affect fuel efficiency. 
Gentler driving (less acceleration, minimal dramatic braking) and 
constant speeds (using cruise control where appropriate) 
...
But we don't buy fuel to move vehicles.
We pay for fuel to move people and freight!
So another way to measure vehicle efficiency focuses on the transportation service and 
quantifies transportation efficiency in passenger-km/liter or tonne-km/liter.
This simple shift exposes the absurdity of Figure~\ref{fig:commuting_by_mode}.
When 76.4~\% of all communiting kilometers are taken in single-occupant vehicles,
a simple way to become more efficient is to increase
...
are filled to capacity when moving freight.
...
Another way to tackle sustainability concerns related to transportation is to 
...
% Figure~\ref{fig:ev_ic_comparison} compares electric and internal combustion vehicles.
% 
% \begin{figure}
% \centering
% \includegraphics[width=1\linewidth]{chapters/ch08/Electric_Vehicles_vs_Internal_Combustion_Engine_Vehicles.pdf}
% \caption[EV and IC vehicle comparison.]{Electric and internal combustion vehicle comparison.}
% \label{fig:ev_ic_comparison}
% \end{figure}
...
\caption[Percentages of delivery cost.]{Percentage of delivery cost by part of journey.}
\label{fig:last_mile}
\end{figure}
...
\begin{mcframe}[0.9\textwidth](0.85\textwidth)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section*{Case study: electric vs.\ internal combustion vehicles}
\label{sec:ev_vs_ice}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

The transportation challenge provides an example of sustainability tradeoffs and problem shifting\index{problem shifting}.
...
across the full life cycle\index{life cycle~of automobiles}
of automobile use,
from base vehicle manufacturing to the end of life disposal,
...
Automobile technology is one of many arenas where sustainability tradeoffs are observed.
EVs reduce global warming impact relative to ICE vehicles 
at the expense of depleting the stock of mineral resources,
a phenemonon called \emph{problem shifting}\index{problem shifting}.

The challenges don't end with the GHG emissions/mineral resource depletion tradeoff.
Whether or not GHG emissions are lower for an EV relative to an ICE vehicle also depends upon 
the service lifetime of the vehicle. 
An EV that is totalled shortly after manufacture will never achieve reduced emissions compared to an ICE vehicle,
because manufacturing comprises a larger fraction of lifetime GHG emissions for EVs relative to ICE vehicles.
\end{mcframe}


% \begin{figure}
% \centering
% \includegraphics[width=1\linewidth]{chapters/ch08/autos_embodied_gwp.pdf}
% \caption[GWP by phase of auto life.]{Global warming potential by phase of life 
%                                      for various types of automobiles.
%                                      Data from~\citet[Fig.~1]{Hawkins_2012}.}
% \label{fig:auto_gwp}
% \end{figure}
...
# Assign some variables to avoid 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Challenges}
\label{sec:transport_challenges}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
