...
\begin{document}
 ...
 \mainmatter
    \Sexpr{knit_child("chapters/ch01/ch01.Rnw")} % Introduction                 \ref{chap:introduction}
    \Sexpr{knit_child("chapters/ch02/ch02.Rnw")} % Population                   \ref{chap:population}
    \Sexpr{knit_child("chapters/ch03/ch03.Rnw")} % Economy                      \ref{chap:economy}
    \Sexpr{knit_child("chapters/ch04/ch04.Rnw")} % Energy                       \ref{chap:energy}
    \Sexpr{knit_child("chapters/ch05/ch05.Rnw")} % Air and water                \ref{chap:air_and_water}
    \Sexpr{knit_child("chapters/ch06/ch06.Rnw")} % Plants and animals           \ref{chap:chap:plants_and_animals}
    \Sexpr{knit_child("chapters/ch07/ch07.Rnw")} % Food and agriculture         \ref{chap:food_and_agriculture}
    \Sexpr{knit_child("chapters/ch08/ch08.Rnw")} % Transportation               \ref{chap:transportation}
    \Sexpr{knit_child("chapters/ch09/ch09.Rnw")} % Housing and households       \ref{chap:housing_and_households}
    \Sexpr{knit_child("chapters/ch10/ch10.Rnw")} % Land use and urban planning  \ref{chap:land_use}
    \Sexpr{knit_child("chapters/ch11/ch11.Rnw")} % Government and regulations   \ref{chap:government_and_regulstions}
    \Sexpr{knit_child("chapters/ch12/ch12.Rnw")} % Systems thinking             \ref{chap:systems_thinking}
    \Sexpr{knit_child("chapters/ch13/ch13.Rnw")} % Values and religion          \ref{chap:values_and_religion}
    \Sexpr{knit_child("chapters/ch14/ch14.Rnw")} % Personal actions             \ref{chap:personal_actions}
