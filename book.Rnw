...
\usepackage[square,comma,sort,numbers,sectionbib]{natbib} % numbered

% Begin packages imported by the authors.
\usepackage{wrapfig}     % To wrap text around figures.
\usepackage{chapterbib}  % For bibliographies at the end of each chapter


% End packages imported by the authors.
...
\begin{document}
 ...
 \mainmatter
    \Sexpr{knit_child("ch01.Rnw")}
    \Sexpr{knit_child("ch02.Rnw")}
    \Sexpr{knit_child("ch03.Rnw")}
    \Sexpr{knit_child("ch04.Rnw")}
    \Sexpr{knit_child("ch05.Rnw")}
    \Sexpr{knit_child("ch06.Rnw")}
    \Sexpr{knit_child("ch07.Rnw")}
    \Sexpr{knit_child("ch08.Rnw")}
    \Sexpr{knit_child("ch09.Rnw")}
    \Sexpr{knit_child("ch10.Rnw")}
    \Sexpr{knit_child("ch11.Rnw")}
    \Sexpr{knit_child("ch12.Rnw")}
    \Sexpr{knit_child("ch13.Rnw")}
    \Sexpr{knit_child("ch14.Rnw")}
